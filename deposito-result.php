...
$monto = isset($_SESSION["ultimoDeposito"]) ? $_SESSION["ultimoDeposito"] : 0;
...
<head>
    ...
    <title>Depósito Exitoso - <?php echo $appTitle; ?></title>
...
<div class="w-full max-w-md">
    <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
        <div class="bg-green-500 px-6 py-6 flex justify-center">
        ...
        <div class="p-6 text-center">
            <h2 class="text-xl font-bold text-slate-800 mb-2">¡Depósito Exitoso!</h2>
            <p class="text-slate-500 mb-6">Su transacción ha sido procesada correctamente</p>
            
            <div class="bg-green-50 rounded-xl p-4 mb-4">
                <p class="text-sm text-green-600 mb-1">Monto depositado</p>
                <p class="text-2xl font-bold text-green-700">+<?php echo number_format(floatval($monto ?? 0), 2); ?> Bs.</p>
            </div>
